...
import br.com.testeAndroidV2.testeandroidv2.databinding.ActivityStatementsBinding
...
class StatementsActivity : AppCompatActivity() {
    ...
    private fun initializeItensAppBar() {
        ...
        binding.itemStatements.textViewAccount.text =
            user.bankAccount.plus(" / " + Validator.formatAgency(user.agency.toString()))
        binding.itemStatements.textviewBalance.text =
            Validator.formatDoubleToString(user.balance, true)
    }
