...
import br.com.testeAndroidV2.data.BuildConfig
...
class TesteAndroidv2ImplService : TesteAndroidV2Service {
    companion object {
    ...
    override fun fetchUserByLoginAndPassword(login: String, password: String): Single<LoginResponse> {
        return testeAndroidV2Service.fetchUserByLoginAndPassword(login, password)
    }

    override fun fetchStatementsByUserId(userId: Int): Single<StatementsResponse> {
